...
let shrimpCreoleIngredients: [Ingredient] = [Ingredient(name: "Olive oil", qty: "2 tbpsns"), Ingredient(name: "Green bell peppers", qty: "0.5 cup"), Ingredient(name: "Onions", qty: "0.5 cup"), Ingredient(name: "Celery", qty: "0.5 cup"), Ingredient(name: "Chili powder", qty: "1 tspn"), Ingredient(name: "Tomatoes", qty: "1 (14 oz.) can"), Ingredient(name: "Tomato sauce", qty: "1 (8 oz.) can"), Ingredient(name: "Hot sauce", qty: "1 tbspn"), Ingredient(name: "Worcestershire sauce", qty: "1 tbspn"), Ingredient(name: "White sugar", qty: "1 tbspn"), Ingredient(name: "Salt"), Ingredient(name: "Pepper"), Ingredient(name: "Shrimp", qty: "1.5 lbs"), Ingredient(name: "Green onions")]

let lasagnaIngredients: [Ingredient] = [Ingredient(name: "Ground beef", qty: "1.5 lbs"), Ingredient(name: "Italian sausage", qty: "0.5 lb"), Ingredient(name: "Onion", qty: "1"), Ingredient(name: "Garlic cloves", qty: "2-3"), Ingredient(name: "Salt", qty: "1.5-2 tspns"), Ingredient(name: "Black pepper", qty: "1 tspn"), Ingredient(name: "Dried parsley flakes", qty: "1 tbspn"), Ingredient(name: "Oregano", qty: "1 tbspn"), Ingredient(name: "Dried basil", qty: "1 tbspn"), Ingredient(name: "Tomatoes", qty: "2 (14.5 oz.) cans"), Ingredient(name: "Tomato paste", qty: "2 (6 oz.) cans"), Ingredient(name: "Ricotta cheese", qty: "24 oz."), Ingredient(name: "Eggs", qty: "2"), Ingredient(name: "Pepper", qty: "0.5 tspn"), Ingredient(name: "Parsley", qty: "2 tbspn"), Ingredient(name: "Parmesan cheese", qty: "0.5 cup"), Ingredient(name: "Mozzarella cheese", qty: "1 lb"), Ingredient(name: "Lasagna noodles", qty: "12-15")]
